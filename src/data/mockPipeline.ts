...
export const mockPipelineStages: StageMeta[] = [
  ...
  { id: "context", icon: "context", status: "current", detail: "Phase 5 · prompt assembly" },
  { id: "llm", icon: "llm", status: "upcoming", detail: "Ollama · local" },
...
export const mockQueryPipelineStages: StageMeta[] = [
  ...
  { id: "context", icon: "context", status: "done", detail: "assembled from retrieved chunks" },
  { id: "llm", icon: "llm", status: "upcoming", detail: "Phase 5 · not implemented" },
  { id: "answer", icon: "answer", status: "upcoming", detail: "Phase 5 · not implemented" },
];
